        ...
        Modernizr['inputtypes'] = (function(props) {
            ...
            for ( var i = 0, bool, inputElemType, defaultView, len = props.length; i < len; i++ ) {
                ...
                if ( bool ) {
                    ...
                    } else if ( /^(url|client_id)$/.test(inputElemType) ) {
                      // Real url and client_id support comes with prebaked validation.
            ...
            return inputs;
        })('search tel url client_id datetime date month week time datetime-local number range color'.split(' '));
    }
